  ...
  exports.Network = [
    ...
    {    fn: "findNetworks",
      ...
      doc: "Find Networks by search expression. " +
        "The search expression will, at a minimum, enable search based on text in the name or description, " +
        "values of network attributes such as owner, format, or keywords, " +
        "and terms referenced by the nodes of the network. ",
      method: "GET",
      route: "/networks",
      queryParams: {
...
})(typeof exports === 'undefined' ? this['ndex_api_spec'] = {} : exports);
