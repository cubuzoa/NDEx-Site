...
exports.updateGroupProfile = function (groupRID, profile, callback)
{
    ...
    common.ndexPost(module.dbHost,
        "ndexGroupUpdateProfile/" + module.dbName,
        module.dbUser,
        module.dbPassword,
        postData,
        function (result)
...
exports.getGroupByName = function (groupname, callback)
{
    ...
    common.ndexGet(module.dbHost,
        "ndexGetGroupByName/" + module.dbName,
        module.dbUser,
        module.dbPassword,
        parameters,
        function (result)
...
exports.deleteGroup = function (groupRID, callback)
{
    ...
    var postData = { "groupJid": groupRID };

    common.ndexPost(module.dbHost,
        "ndexGroupDelete/" + module.dbName,
        module.dbUser,
        module.dbPassword,
        postData,
        function (result)
