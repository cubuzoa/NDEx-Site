...
exports.findGroups = function (searchExpression, limit, offset, callback){
	...
	var descriptors = " groupname as groupname, organizationName as organizationName, @rid as jid ";
    var cmd = "select"+ descriptors +"from xGroup where groupname.toUpperCase()  like '%" + searchExpression + "%'  order by creation_date desc skip " +  start + " limit " + limit;
