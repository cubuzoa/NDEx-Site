exports.resourceTypes = ["System", "User", "Agent", "Group", "Request", "Network", "Task"];
...
[
    {
        ...
        putData:
        {
            username: { doc: "username", type: "string" },
            password: { doc: "password", type: "string" },
            email: { doc: "email address for password recovery, default email for account", type: "string" }
        },
        response:
        {
            jid: { doc: "the id of the new user", type: "JID", class: "xUser" }
        },
        exceptions: ["400 user name already used", "400 invalid name", "400 invalid password"]
    },
    {
        ...
        response: {},
        exceptions: ["404 unknown user id", "401 Requester not authorized"]
    },
    {
        fn: "uploadUserImage",
        status: "active",
